...
const NEIGHBOURS = new Map<string, NeighbourDisplayRow>([
  ["77", { label: "77", catalogue_ordinal: 77, best_product: null, within_medoid_distance: { esm: null, bacformer: null }, display_name: "rfaL", display_name_source: "O-antigen ligase", genome_count: 90, median_gene_length_nt: 1230, prevalence_band: "core" }],
  ["78", { label: "78", catalogue_ordinal: 78, best_product: null, within_medoid_distance: { esm: null, bacformer: null }, display_name: "waaL", display_name_source: "ligase", genome_count: 20, median_gene_length_nt: 900, prevalence_band: "shell" }],
]);
